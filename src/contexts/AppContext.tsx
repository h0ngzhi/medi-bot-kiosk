...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'health.high': 'High',
    'health.assessment': 'AI Assessment',
    ...
    'community.filterActive': 'Active Ageing',
    'community.filterHealth': 'Health Education',
    ...
    'community.seeTranslation': 'See translation',
    'community.hideTranslation': 'Hide translation',
    'community.translating': 'Translating...',
    'community.translationError': 'Could not translate',
    ...
    'community.you': 'You',
    'community.categoryActiveAgeing': 'Active Ageing',
    'community.categoryHealthEducation': 'Health Education',
    'community.categorySocial': 'Social',
    'community.categoryCaregiver': 'Caregiver Support',
    'community.categoryDigitalLiteracy': 'Digital Skills',
    'community.navigationCard': 'Navigation Card',
    'community.printNavigationCard': 'Print Navigation Card',
    ...
    'profile.howPointsWork': 'How Points Work',
    'profile.eventPointsRule': 'Earn up to 10 points from events per day',
    'profile.maxDailyPointsRule': 'Maximum 15 points total per day (5 login + 10 events)',
    ...
    'profile.printing': 'Printing...',
    'profile.printed': 'Printed!',
    'profile.medalEquipped': 'Medal Equipped!',
    'profile.medalUnequipped': 'Medal Unequipped',
    'profile.certificatePrinted': 'Certificate Printed!',
    'profile.collectCertificate': 'Please collect your certificate from the printer.',
    'profile.equipFailed': 'Failed to equip medal',
    'profile.alreadyRedeemed': 'You have already redeemed the maximum quantity.',
  ...
  zh: {
    ...
    'health.warning': '偏高',
    'health.high': '高',
    'health.assessment': 'AI评估',
    'health.recommendations': '建议',
    'health.date': '测量日期',
    ...
    'community.filterActive': '乐龄活动',
    'community.filterHealth': '健康教育',
    ...
    'community.completed': '已完成',
    'community.registrationClosed': '报名已截止',
    'community.programmeStarted': '活动已开始，报名已截止。',
    'community.leaveFeedback': '留下评价',
    'community.shareFeedback': '分享您的反馈',
    'community.rateExperience': '您的体验如何？',
    'community.participantFeedback': '参与者反馈',
    'community.feedbackAlreadySubmitted': '您已为此活动提交过反馈。',
    'community.feedbackError': '提交反馈失败，请重试。',
    'community.feedbackSubmittedShort': '反馈已提交',
    'community.cannotCancelStarted': '活动已开始，无法取消。',
    ...
    'community.seeTranslation': '查看翻译',
    'community.hideTranslation': '隐藏翻译',
    'community.translating': '翻译中...',
    'community.translationError': '无法翻译',
    'community.updateFeedback': '更新反馈',
    'community.feedbackUpdated': '反馈已更新',
    'community.tapToView': '点击查看',
    'community.eventsAttended': '次活动参与',
    'community.you': '您',
    'community.categoryActiveAgeing': '活跃乐龄',
    'community.categoryHealthEducation': '健康教育',
    'community.categorySocial': '社交活动',
    'community.categoryCaregiver': '护理者支援',
    'community.categoryDigitalLiteracy': '数码技能',
    'community.navigationCard': '导航卡',
    'community.printNavigationCard': '打印导航卡',
    ...
    'profile.dailyBonusRule': '每日登录可获5积分（凌晨12点重置）',
    'profile.dailyBonusClaimed': '已领取每日奖励！',
    'profile.dailyBonusDesc': '您今天登录获得了5积分奖励。',
    'profile.howPointsWork': '积分规则',
    'profile.eventPointsRule': '每日活动最多可获10积分',
    'profile.maxDailyPointsRule': '每日最多获得15积分（5登录 + 10活动）',
    ...
    'profile.printing': '打印中...',
    'profile.printed': '已打印！',
    'profile.medalEquipped': '徽章已装备！',
    'profile.medalUnequipped': '徽章已卸下',
    'profile.certificatePrinted': '证书已打印！',
  ...
  ms: {
    ...
    'health.normal': 'Normal',
    'health.warning': 'Meningkat',
    'health.high': 'Tinggi',
    'health.assessment': 'Penilaian AI',
    'health.recommendations': 'Cadangan',
    ...
    'community.filterActive': 'Penuaan Aktif',
    'community.filterHealth': 'Pendidikan Kesihatan',
    ...
    'community.completed': 'Selesai',
    'community.registrationClosed': 'Pendaftaran Ditutup',
    'community.programmeStarted': 'Pendaftaran ditutup kerana program telah bermula.',
    'community.leaveFeedback': 'Tinggalkan Maklum Balas',
    'community.shareFeedback': 'Kongsi Maklum Balas Anda',
    'community.rateExperience': 'Bagaimana pengalaman anda?',
    'community.participantFeedback': 'Maklum Balas Peserta',
    'community.feedbackAlreadySubmitted': 'Anda telah menghantar maklum balas untuk program ini.',
    'community.feedbackError': 'Gagal menghantar maklum balas. Sila cuba lagi.',
    'community.feedbackSubmittedShort': 'Maklum Balas Dihantar',
    'community.cannotCancelStarted': 'Tidak boleh dibatalkan kerana program telah bermula.',
    ...
    'community.seeTranslation': 'Lihat terjemahan',
    'community.hideTranslation': 'Sembunyikan terjemahan',
    'community.translating': 'Menterjemah...',
    'community.translationError': 'Tidak dapat menterjemah',
    ...
    'community.you': 'Anda',
    'community.categoryActiveAgeing': 'Penuaan Aktif',
    'community.categoryHealthEducation': 'Pendidikan Kesihatan',
    'community.categorySocial': 'Sosial',
    'community.categoryCaregiver': 'Sokongan Penjaga',
    'community.categoryDigitalLiteracy': 'Kemahiran Digital',
    'community.navigationCard': 'Kad Navigasi',
    'community.printNavigationCard': 'Cetak Kad Navigasi',
    ...
    'profile.dailyBonusRule': 'Dapatkan 5 mata setiap hari (bonus log masuk, reset 12 tengah malam)',
    ...
    'profile.howPointsWork': 'Cara Mata Berfungsi',
    'profile.eventPointsRule': 'Dapatkan sehingga 10 mata dari acara setiap hari',
    'profile.maxDailyPointsRule': 'Maksimum 15 mata sehari (5 log masuk + 10 acara)',
    ...
    'profile.printing': 'Mencetak...',
    'profile.printed': 'Dicetak!',
    'profile.medalEquipped': 'Pingat Dilengkapi!',
    'profile.medalUnequipped': 'Pingat Ditanggalkan',
    'profile.certificatePrinted': 'Sijil Dicetak!',
    'profile.collectCertificate': 'Sila ambil sijil anda dari mesin pencetak.',
  ...
  ta: {
    ...
    'health.warning': 'உயர்ந்த',
    'health.high': 'அதிக',
    'health.assessment': 'AI மதிப்பீடு',
    ...
    'community.filterActive': 'சுறுசுறுப்பான வயதாகுதல்',
    'community.filterHealth': 'சுகாதாரக் கல்வி',
    ...
    'community.completed': 'முடிந்தது',
    'community.registrationClosed': 'பதிவு முடிவடைந்தது',
    'community.programmeStarted': 'திட்டம் தொடங்கியதால் பதிவு மூடப்பட்டது.',
    'community.leaveFeedback': 'கருத்து தெரிவிக்க',
    'community.shareFeedback': 'உங்கள் கருத்தைப் பகிரவும்',
    'community.rateExperience': 'உங்கள் அனுபவம் எப்படி இருந்தது?',
    'community.participantFeedback': 'பங்கேற்பாளர் கருத்து',
    'community.feedbackAlreadySubmitted': 'இந்த திட்டத்திற்கு நீங்கள் ஏற்கனவே கருத்து தெரிவித்துள்ளீர்கள்.',
    'community.feedbackError': 'கருத்து சமர்ப்பிக்க முடியவில்லை. மீண்டும் முயற்சிக்கவும்.',
    'community.feedbackSubmittedShort': 'கருத்து சமர்ப்பிக்கப்பட்டது',
    'community.cannotCancelStarted': 'திட்டம் தொடங்கியதால் ரத்து செய்ய முடியாது.',
    ...
    'community.seeTranslation': 'மொழிபெயர்ப்பைக் காண்க',
    'community.hideTranslation': 'மொழிபெயர்ப்பை மறை',
    'community.translating': 'மொழிபெயர்க்கிறது...',
    'community.translationError': 'மொழிபெயர்க்க இயலவில்லை',
    ...
    'community.categoryActiveAgeing': 'சுறுசுறுப்பான வயதாதல்',
    'community.categoryHealthEducation': 'சுகாதார கல்வி',
    'community.categorySocial': 'சமூக நடவடிக்கை',
    'community.categoryCaregiver': 'பராமரிப்பாளர் ஆதரவு',
    'community.categoryDigitalLiteracy': 'டிஜிட்டல் திறன்கள்',
    'community.navigationCard': 'வழிசெலுத்தல் அட்டை',
    'community.printNavigationCard': 'வழிசெலுத்தல் அட்டையை அச்சிடு',
    ...
    'profile.dailyBonusRule': 'தினமும் 5 புள்ளிகள் பெறுங்கள் (உள்நுழைவு போனஸ், நள்ளிரவு 12 மணிக்கு மீட்டமைப்பு)',
    ...
    'profile.howPointsWork': 'புள்ளிகள் எப்படி வேலை செய்கின்றன',
    'profile.eventPointsRule': 'நிகழ்வுகளிலிருந்து தினமும் 10 புள்ளிகள் வரை பெறலாம்',
    'profile.maxDailyPointsRule': 'நாளொன்றுக்கு அதிகபட்சம் 15 புள்ளிகள் (5 உள்நுழைவு + 10 நிகழ்வுகள்)',
    ...
    'profile.printing': 'அச்சிடுகிறது...',
    'profile.printed': 'அச்சிடப்பட்டது!',
    'profile.medalEquipped': 'பதக்கம் பொருத்தப்பட்டது!',
    'profile.medalUnequipped': 'பதக்கம் அகற்றப்பட்டது',
    'profile.certificatePrinted': 'சான்றிதழ் அச்சிடப்பட்டது!',
